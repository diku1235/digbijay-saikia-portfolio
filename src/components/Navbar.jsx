...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 max-w-[1400px] mx-auto px-6">
      <nav className="bg-[#f5f7f9]/[0.85] backdrop-blur-2xl rounded-[130px] flex items-center justify-between py-4 px-6 sm:px-10 shadow-sm">
        {/* Logo */}
        ...
        {/* Mobile Dropdown */}
        <ul
          className={`absolute top-full left-0 w-full bg-white rounded-lg shadow-md p-4 flex flex-col gap-4 text-lg font-medium text-gray-800 lg:hidden z-50 transition-all duration-300 ease-in-out overflow-hidden ${menuOpen ? 'max-h-[500px] opacity-100 translate-y-0 mt-2' : 'max-h-0 opacity-0 -translate-y-2 mt-0'}`}
        >
          <li><a href="#hero" className="text-[#1465ff]">Home</a></li>
          <li><a href="#services" className="hover:text-[#1465ff]">Services</a></li>
          <li><a href="#about" className="hover:text-[#1465ff]">About Me</a></li>
          <li><a href="#projects" className="hover:text-[#1465ff]">Projects</a></li>
          <li>
