...
export default function Hero() {
  return (
    <section id="hero" className="scroll-mt-28 max-w-[1400px] mx-auto px-6 py-10 md:py-20 mt-6 lg:mt-0">
      {/* Main content with responsive spacing */}
      <div className="flex flex-col md:flex-row items-center justify-between mb-12 sm:mb-16 md:mb-20 lg:mb-40 gap-8 sm:gap-12 md:gap-12 lg:gap-16">
        {/* Left content */}
