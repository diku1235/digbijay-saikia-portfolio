    ...
    <footer className="bg-[#1f1f1f] text-white mt-28 px-6 sm:px-12 md:px-24 py-0 rounded-t-[2rem]">
      <div className="max-w-[1400px] mx-auto px-6 py-10 md:py-20 mt-10">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between mb-12 gap-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-left">Let’s Connect there</h2>
        ...
        <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] lg:grid-rows-1 text-sm text-left">
          ...
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-xl font-bold font-mono">Digbijay Saikia</span>
            </div>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-bold mb-3">Get the latest information</h4>
            <form className="flex mt-3">
              <input
                type="email"
                placeholder="Email Address"
                className="px-4 py-2 w-full bg-white text-black rounded-l-full outline-none"
              />
              <button
                type="submit"
